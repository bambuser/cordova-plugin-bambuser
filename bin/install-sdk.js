...
var sdks = {
  android: {
    url: "https://dist.bambuser.com/android_sdk/libbambuser-android-1.0.1-220629.zip",
  },
  ios: {
...
if (!sdk) {
  throw new Error(
    "Unknown SDK specified, valid options: " + Object.keys(sdks).join(", ")
  );
}
...
var stream = request({
  url: sdk.url,
  pool: new https.Agent({ keepAlive: false }),
});
